...
var dark = document.querySelector(".dark-bt")
var light = document.querySelector(".light-bt")
var dark_icon_search = document.querySelector(".search-bt")
var dark_icon_bag = document.querySelector(".bag-bt")
var dark_icon_more = document.querySelector(".more-bt")
var dark_icon_user = document.querySelector(".user-bt")
...
var ct2_title = document.querySelector(".ct2-title")
var ct2_p1 = document.querySelector(".ct2-p1")
var ct2_p2 = document.querySelector(".ct2-p2")
var ct2_p3 = document.querySelector(".ct2-p3")
var ct2_p4 = document.querySelector(".ct2-p4")
var ct2_p5 = document.querySelector(".ct2-p5")
var ct2_p6 = document.querySelector(".ct2-p6")
var ct2_p7 = document.querySelector(".ct2-p7")
var ct2_p8 = document.querySelector(".ct2-p8")
var ct3_title = document.querySelector(".ct3-title")
var ct3_p2 = document.querySelector(".ct3-p2")
var ct3_p4 = document.querySelector(".ct3-p4")
var ct4_title = document.querySelector(".ct4-title")
var ct4_p2 = document.querySelector(".ct4-p2")
var ct5_title = document.querySelector(".ct5-title")
var ct6_title = document.querySelector(".ct6-title")
var ct6_p1 = document.querySelector(".ct6-p1")
var ct7_title = document.querySelector(".ct7-title")
...
dark.addEventListener("click",function(){
    ...
    div_header.classList.add("dark1");
    dark_icon_search.classList.add("dark-search");
    dark_icon_bag.classList.add("dark-bag");
    dark_icon_more.classList.add("dark-more");
    dark_icon_user.classList.add("dark-user");
    light.classList.add("dark-mode");
    title.classList.add("color-dark");
    title1.classList.add("color-dark");
    title2.classList.add("color-dark");
    ct2_title.classList.add("dark-ct2-title")
    ct2_p1.classList.add("ct2-dark")
    ct2_p2.classList.add("ct2-dark")
    ct2_p3.classList.add("ct2-dark")
    ct2_p4.classList.add("ct2-dark")
    ct2_p5.classList.add("ct2-dark")
    ct2_p6.classList.add("ct2-dark")
    ct2_p7.classList.add("ct2-dark")
    ct2_p8.classList.add("ct2-dark")
    ct3_title.classList.add("ct2-dark")
    ct3_p2.classList.add("ct2-dark")
    ct3_p4.classList.add("ct2-dark")
    ct4_title.classList.add("ct2-dark")
    ct4_p2.classList.add("ct2-dark")
    ct5_title.classList.add("ct2-dark")
    ct6_title.classList.add("ct2-dark")
    ct6_p1.classList.add("ct2-dark")
    ct7_title.classList.add("ct2-dark")
})
...
light.addEventListener("click",function(){
    ...
    div_header.classList.remove("dark1");
    dark_icon_search.classList.remove("dark-search");
    dark_icon_bag.classList.remove("dark-bag");
    dark_icon_more.classList.remove("dark-more");
    dark_icon_user.classList.remove("dark-user");
    light.classList.remove("dark-mode");
    title.classList.remove("color-dark");
    title1.classList.remove("color-dark");
    title2.classList.remove("color-dark");
    ct2_title.classList.remove("dark-ct2-title");
    ct2_p1.classList.remove("ct2-dark")
    ct2_p2.classList.remove("ct2-dark")
    ct2_p3.classList.remove("ct2-dark")
    ct2_p4.classList.remove("ct2-dark")
    ct2_p5.classList.remove("ct2-dark")
    ct2_p6.classList.remove("ct2-dark")
    ct2_p7.classList.remove("ct2-dark")
    ct2_p8.classList.remove("ct2-dark")
    ct3_title.classList.remove("ct2-dark")
    ct3_p2.classList.remove("ct2-dark")
    ct3_p4.classList.remove("ct2-dark")
    ct4_title.classList.remove("ct2-dark")
    ct4_p2.classList.remove("ct2-dark")
    ct5_title.classList.remove("ct2-dark")
    ct6_title.classList.remove("ct2-dark")
    ct6_p1.classList.remove("ct2-dark")
    ct7_title.classList.remove("ct2-dark")
})
